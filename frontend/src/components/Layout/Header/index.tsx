...
import { menuDataStudent } from './Navigation/menuDataStudent'
import { menuDataAdmin } from './Navigation/menuDataAdmin'
import { menuDataEmploye } from './Navigation/menuDataEmploye'
...
const Header: React.FC = () => {
    ...
    const [menuItems, setMenuItems] = useState(headerData); // par défaut public
    ...
    return (
        <header
            className={`z-40 w-full transition-all fixed top-0 duration-300 ${sticky ? 'shadow-lg bg-white py-6' : 'shadow-none bg-transparent py-6'
                }`}>
            
            <div className='lg:py-0 py-2'>
                {user ? (<div className='container flex items-center justify-between'>
                    <Logo />
